...
\small
\textbf{ImgSensingNet: Vision Guided Aerial-Ground Air Quality Sensing System}

\vspace{.02in}
Advisor: Prof. Lingyang Song \& Prof. Kaigui Bian, PKU \hfill {Dec. 2017 - Present}

\vspace{.08in}
\begin{innerlist}
	\item[$-$] Implemented \emph{ImgSensingNet}, a vision guided aerial-ground AQI sensing system using UAV vision and on-ground wireless sensor network (WSN), in the real-world testbed
	\vspace{.03in}
	\item[$-$] Designed content-nonspecific haze-relevant features, and a 3D convolutional neural network (CNN) for end-to-end learning between raw haze images and AQI scale inference
	\vspace{.03in}
	\item[$-$] Proposed an entropy-based inference model for ground WSN, achieving a high accuracy in both real-time AQI distribution estimation and future AQI distribution prediction
	\vspace{.03in}
	\item[$-$] Designed a wake-up schedule that connects the aerial vision with the ground WSN, which greatly save the system's energy consumptions while ensuring high inference accuracy
\end{innerlist}
...
\textbf{Realtime Profiling of Fine-Grained 3D AQI Distribution using UAV Sensing}

\vspace{.02in}
Advisor: Prof. Lingyang Song \& Prof. Kaigui Bian, PKU \hfill {Dec. 2016 - Jun. 2017}

\vspace{.08in}
\begin{innerlist}
\item[$-$] Designed a mobile sensing system by unmanned-aerial-vehicle (UAV) to profile realtime fine-grained 3D AQI map
    \vspace{.03in}
\item[$-$] Proposed a novel distribution model that consists of a linear part using Gaussian Plume model, and a non-linear part using Artificial Neural Networks
    \vspace{.03in}
\item[$-$] Designed the adaptive monitoring algorithms for UAV measurement, and formulated a sub-optimal trajectory planning algorithm
\end{innerlist}
...
\begin{innerlist}
\item \textbf{First Prize} (No.1 out of 23 finalists) \hfill Nov. 2017\\
IEEE ComSoc International Student Competition 2017
\end{innerlist}

\halfblankline

\textbf{Student Awards --- Peking University}
\begin{innerlist}
\item Top Ten Undergraduate Dissertation Award, 10 in 400 in EECS Dept. \hfill 2018

\vspace{.02in}
\item National Scholarship (\textbf{highest honor}), Top 0.1\% nationwide \hfill 2017

\vspace{.02in}
\item HuaWei Scholarship, Top 0.7\% in EECS Dept. \hfill 2017

\vspace{.02in}
\item Outstanding Undergraduate Research Award, Top 1\% among undergrads \hfill 2017

\vspace{.02in}
\item Distinguished All-Round Student \hfill 2016, 2017

\vspace{.02in}
\item Samsung Scholarship, Samsung Electronics Co., Ltd \hfill 2016

\vspace{.02in}
\item Outstanding Research Award \hfill 2015

\vspace{.02in}
\item WuSi Scholarship, PKU \hfill 2015
\end{innerlist}
...
\begin{innerlist}
	\item IEEE Trans. Vehicular Technology
